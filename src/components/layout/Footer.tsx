...
import { MapPin, Phone, Mail, AtSign, Hash, Globe } from "lucide-react";
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 group">
                ...
                <a href="mailto:emadabuhamdeh@gmail.com" className="text-gray-500 text-sm hover:text-[#6CC04A] transition-colors link-lift inline-block">
                  emadabuhamdeh@gmail.com
                </a>
              </li>
            </ul>
          </div>
