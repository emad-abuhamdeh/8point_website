...
import { MapPin, Phone, Mail, Clock, CheckCircle2, AtSign, Globe, Hash, ArrowRight, MessageSquare, Calendar, Send } from "lucide-react";
import logoIcon from "@assets/image_1775695227438.svg";
import { useState } from "react";
import { useToast } from "@/hooks/use-toast";

const EMAIL_RECIPIENT = "emadabuhamdeh@gmail.com";
const FORM_SUBMIT_URL = `https://formsubmit.co/${EMAIL_RECIPIENT}`;
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = `New inquiry from ${form.name || "website visitor"}`;
    ...
    try {
      ...
      toast({ title: "Message received!", description: `Your form was sent to ${EMAIL_RECIPIENT}.` });
      setForm({ name: "", email: "", company: "", budget: "", message: "" });
      setSelectedService(null);
    } catch (error) {
      toast({ title: "Send failed", description: "Unable to send your message. Please try again later.", variant: "destructive" });
    } finally {
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute right-0 top-0 bottom-0 flex items-center pr-0 select-none pointer-events-none">
            <img src={logoIcon} alt="" style={{ width: "760px", opacity: 0.12, mixBlendMode: "screen" }} />
          </div>
        </div>
            ...
            >
              ...
              <div className="bg-gray-900/60 border border-white/10 rounded-3xl p-8">
                ...
                <div className="space-y-6">
                  ...
                  <a href="mailto:emadabuhamdeh@gmail.com" className="flex items-start gap-4 group">
                    <div className="w-11 h-11 rounded-xl bg-[#6CC04A]/15 flex items-center justify-center flex-none group-hover:bg-[#6CC04A]/25 transition-colors">
